...
def main():
    ...
    st.markdown('<div class="main-header">🔍 NexaCore AI Research Assistant</div>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        st.info("**About Our Documents:**\n- 157 AI-generated documents\n- Imaginary company operations\n- Organized by department")
        ...
        st.metric("Documents", "157")
        st.metric("Avg Confidence", "97%")
    ...
    with tab1:
        ...
        suggestions = [
            ...
            "What's the customer support resource allocation plan for 2026?",
            "What are the performance and latency targets for our API gateway?",
            "What are NexaCore's core messaging pillars and brand voice guidelines?",
            "What is the incident reporting procedure for facility emergencies?"
        ]
